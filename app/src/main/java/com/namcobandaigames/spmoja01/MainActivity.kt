...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (prefs.getBoolean("activity_exec", false)) {
            Intent(this, ActivityPath::class.java).also { startActivity(it) }
            finish()
        } else {
            val exec = prefs.edit()
    ...
    private fun appsdk() {
        val conversionDataListener = object : AppsFlyerConversionListener {
            override fun onConversionDataSuccess(data: Map<String, Any>) {
                ...
                shString = (data["campaign"] as String?)!!
                Log.d("NAMING", "campaign attributed: $shString")

                val tokenizer = StringTokenizer(shString, "_")
    ...
    fun invHander() {
        Intent(this, ActivityPath::class.java)
